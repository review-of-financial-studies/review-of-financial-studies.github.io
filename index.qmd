...
![](assets/img/process.svg){.lightbox fig-alt="RFS Data Editor process diagram with four phases — Preparation, Review, Verification, and Release — and steps color-coded by responsibility (editor in blue, data editor in green, author in yellow)." fig-align="center" width="60%" title="Click to enlarge"}
