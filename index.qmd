...
Experience from prior reviews indicates that a limited set of recurring issues accounts for most delays during the data-editing and replication review process. Many of these delays can be avoided by ensuring that the replication package includes a [README](https://social-science-data-editors.github.io/template_README/) that follows the Social Science Data Editors template (version 1.1) for standardized documentation, as well as a [LICENSE file](license.qmd) that clearly specifies the terms governing the use of the code and data.
